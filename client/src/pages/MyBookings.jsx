...
const {axios, user, currency} = useAppContext()
  ...
  return (
    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <div>
        {bookings.map((booking,index)=> (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0}}
            transition={{delaya: index * 0.1, duration: 0.4}}
          ...
          p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
            <div className='md:col-span-1'>
                <div className='rounded-md ocerflow-hidden mb-3'>
