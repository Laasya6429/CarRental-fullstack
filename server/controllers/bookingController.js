...
// API to check Avaialbility of cars for tthe given Date and Location
...
export const getUserBookinks = async (req,res)=>{
    try{
        const {_id} = req.user;
...
export const getOwnerBookings = async (req,res)=>{
    try{
        ...
        .sort({ createdAt: -1 }) // ✔ This one is correct because it is still part of the query
