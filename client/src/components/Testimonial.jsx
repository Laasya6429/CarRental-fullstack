...
const Testimonial = () => {
    const testimonials = [
        { name: "Emma Rodriguez", 
          ...
          testimonial: "I've rented cars from various companies, but the experience with CarRentals was exceptional." 
        },
         { name: "John Smith", 
         ...
         { name: "Ava Johnson", 
          ...
          image: assets.testimonial_image_1, 
          testimonial: "I highly recommended CarRental! Their fleets is amazing, and I always feel like I'm getting the best the best deal with excellent service." 
        },
    ];
  return (
     <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:gris-cols-3 gap-8 mt-18">
